...
export default function Header() {
  ...
  return (
    <header className="bg-white  dark:bg-slate-950 border-b border-gray-200 dark:border-slate-800 sticky top-0 z-50 transition-colors duration-200">
        ...
        <nav className="flex items-center gap-4">
          {status === "loading" ? (
            ...
            <div className="relative" ref={menuRef}>
              ...
              {isOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 border border-gray-200 dark:border-neutral-700 rounded-md shadow-lg py-1 transition-colors duration-200">
                  ...
                  <Link
                    ...
                    className="block px-4 py-2 text-sm text-neutral-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-neutral-700 transition-colors duration-200"
                  >
                    Dashboard
                  </Link>
                  <Link
